...
namespace Pathfinding.Ionic.Zip
{
    ...
    public partial class ZipEntry
    {
        ...
        private static bool ReadHeader(ZipEntry ze, System.Text.Encoding defaultEncoding)
        {
            ...
            int signature = Pathfinding.Ionic.Zip.SharedUtilities.ReadEntrySignature(ze.ArchiveStream);
            bytesRead += 4;
            ...
            if (ZipEntry.IsNotValidSig(signature))
            {
                ...
                // workitem 10178
                Pathfinding.Ionic.Zip.SharedUtilities.Workaround_Ladybug318918(ze.ArchiveStream);
            ...
            ze._LastModified = Pathfinding.Ionic.Zip.SharedUtilities.PackedToDateTime(ze._TimeBlob);
            ...
            if (!ze._FileNameInArchive.EndsWith("/") && (ze._BitField & 0x0008) == 0x0008)
            {
                ...
                while (wantMore)
                {
                    ...
                    long d = Pathfinding.Ionic.Zip.SharedUtilities.FindSignature(ze.ArchiveStream, ZipConstants.ZipEntryDataDescriptorSignature);
                    if (d == -1) return false;
        ...
        private static void HandleUnexpectedDataDescriptor(ZipEntry entry)
        {
            ...
            {
                int sz = Pathfinding.Ionic.Zip.SharedUtilities.ReadInt(s);
                if (sz == entry._CompressedSize)
                {
                    sz = Pathfinding.Ionic.Zip.SharedUtilities.ReadInt(s);
